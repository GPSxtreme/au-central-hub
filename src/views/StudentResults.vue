<template>
  <div>
    ...
    <div class="semesters">
      <button class="sem-btn" @click="loadResults('Sem-1')">
        Sem-1
      </button>
      <button class="sem-btn" @click="loadResults('Sem-2')">
        Sem-2
      </button>
      <button class="sem-btn" @click="loadResults('Sem-3')">
        Sem-3
      </button>
      <button class="sem-btn" @click="loadResults('Sem-4')">
        Sem-4
      </button>
      <button class="sem-btn" @click="loadResults('Sem-5')">
        Sem-5
      </button>
      <button class="sem-btn" @click="loadResults('Sem-6')">
        Sem-6
      </button>
      <button class="sem-btn" @click="loadResults('Sem-7')">
        Sem-7
      </button>
      <button class="sem-btn" @click="loadResults('Sem-8')">
        Sem-8
      </button>
    </div>
